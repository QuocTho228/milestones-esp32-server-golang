...
var (
	defaultOpenClawEnterKeywords = []string{"Mở OpenClaw", "Khởi động OpenClaw"}
	defaultOpenClawExitKeywords  = []string{"Đóng OpenClaw", "Thoát OpenClaw"}
)
...
func mustOpenClawConfigJSON(cfg OpenClawConfigResponse) string {
	...
	if err != nil {
		return `{"allowed":false,"enter_keywords":["Mở OpenClaw","Khởi động OpenClaw"],"exit_keywords":["Đóng OpenClaw","Thoát OpenClaw"]}`
	}
	return string(data)
}
