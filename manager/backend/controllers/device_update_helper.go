...
// Các bản cập nhật thiết bị chỉ được ghi vào các cột được khai báo để tránh ghi lại toàn bộ các trường như `created_at` được tạo tại thời điểm lịch sử bằng không.
