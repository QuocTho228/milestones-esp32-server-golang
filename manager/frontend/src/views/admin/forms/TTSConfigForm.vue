  ...
  <el-form ref="formRef" :model="model" :rules="rules" label-width="220px">
      ...
      <el-select v-model="model.provider" placeholder="Vui lòng chọn nhà cung cấp" style="width: 100%">
        ...
        >
          <div style="display: flex; align-items: center; justify-content: space-between; gap: 8px">
            ...
            <el-tag v-if="provider.supports_voice_clone" size="small" type="success" effect="plain"
              >Hỗ trợ nhân bản giọng nói</el-tag
            >
          </div>
        </el-option>
      </el-select>
    ...
    <template v-if="model.provider === 'doubao_ws'">
      ...
      <el-form-item label="Access Token" prop="doubao_ws.access_token">
        <el-input
          v-model="model.doubao_ws.access_token"
          placeholder="Vui lòng nhập Access Token"
          type="password"
          show-password
        />
      </el-form-item>
      <el-form-item label="Mô hình" prop="doubao_ws.model">
        <el-select v-model="model.doubao_ws.model" placeholder="Vui lòng chọn mô hình" style="width: 100%">
          <el-option
            v-for="option in DOUBAO_MODEL_OPTIONS"
            :key="option.value"
            :label="option.label"
            :value="option.value"
          />
      ...
      <el-form-item label="ID tài nguyên" prop="doubao_ws.resource_id">
        <el-input
          v-model="model.doubao_ws.resource_id"
          placeholder="Tùy chọn; ví dụ: TTS-SeedTTS2.xxxxx, ưu tiên dùng Instance ID từ bảng điều khiển"
        />
      </el-form-item>
      <el-form-item label="Giọng đọc" prop="doubao_ws.voice">
        <el-select
          v-model="model.doubao_ws.voice"
          placeholder="Vui lòng chọn giọng đọc"
          style="width: 100%"
          filterable
        ...
        >
          <el-option
            v-for="option in voiceOptionsList"
            :key="option.value"
            :label="option.label"
            :value="option.value"
          />
      ...
      <el-form-item label="WebSocket URL" prop="doubao_ws.ws_url" label-width="unset">
        <el-input
          v-model="model.doubao_ws.ws_url"
    ...
    <template v-if="model.provider === 'edge'">
      <el-form-item label="Giọng đọc" prop="edge.voice">
        <el-select
      ...
      <el-form-item label="Tốc độ nói" prop="edge.rate">
        <el-input v-model="model.edge.rate" placeholder="Nhập tốc độ nói (ví dụ: +0%)" />
      </el-form-item>
      <el-form-item label="Âm lượng" prop="edge.volume">
        <el-input v-model="model.edge.volume" placeholder="Nhập âm lượng (ví dụ: +0%)" />
      </el-form-item>
      <el-form-item label="Cao độ" prop="edge.pitch">
        <el-input v-model="model.edge.pitch" placeholder="Nhập cao độ (ví dụ: +0Hz)" />
      </el-form-item>
      <el-form-item label="Thời gian chờ kết nối" prop="edge.connect_timeout">
        <el-input-number v-model="model.edge.connect_timeout" :min="1" :max="60" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Thời gian chờ nhận dữ liệu" prop="edge.receive_timeout">
    ...
    <template v-if="model.provider === 'edge_offline'">
      <el-form-item label="URL máy chủ" prop="edge_offline.server_url">
        <el-input v-model="model.edge_offline.server_url" placeholder="Vui lòng nhập URL máy chủ" />
      </el-form-item>
      <el-form-item label="Thời gian chờ" prop="edge_offline.timeout">
        <el-input-number v-model="model.edge_offline.timeout" :min="1" :max="300" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Tần số lấy mẫu" prop="edge_offline.sample_rate">
        <el-input-number v-model="model.edge_offline.sample_rate" :min="8000" :max="48000" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Số kênh âm thanh" prop="edge_offline.channels">
        <el-input-number v-model="model.edge_offline.channels" :min="1" :max="8" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Thời lượng khung (ms)" prop="edge_offline.frame_duration">
    ...
    <template v-if="model.provider === 'aliyun_qwen'">
      ...
      <el-form-item label="Mô hình" prop="qwen_tts.model">
        <el-input v-model="model.qwen_tts.model" placeholder="qwen3-tts-flash" />
      </el-form-item>
      <el-form-item label="Giọng đọc" prop="qwen_tts.voice">
      ...
      <el-form-item label="Bật truyền phát (Streaming)" prop="qwen_tts.stream">
        <el-switch v-model="model.qwen_tts.stream" />
      </el-form-item>
      <el-form-item label="Thời lượng khung (ms)" prop="qwen_tts.frame_duration">
    ...
    <template v-if="model.provider === 'zhipu'">
      ...
      <el-form-item label="Mô hình" prop="zhipu.model">
        <el-input v-model="model.zhipu.model" placeholder="glm-tts" />
      </el-form-item>
      <el-form-item label="Giọng đọc" prop="zhipu.voice">
        <el-select
      ...
      <el-form-item label="Định dạng phản hồi" prop="zhipu.response_format">
        <el-select
          v-model="model.zhipu.response_format"
          placeholder="Vui lòng chọn định dạng phản hồi"
          style="width: 100%"
        >
      ...
      <el-form-item label="Âm lượng" prop="zhipu.volume">
        <el-input-number
          v-model="model.zhipu.volume"
          :min="0"
          :max="10"
          :step="0.1"
          style="width: 100%"
          placeholder="0-10，Mặc định1.0"
        />
      </el-form-item>
      <el-form-item label="Tốc độ nói" prop="zhipu.speed">
        <el-input-number
          v-model="model.zhipu.speed"
          :min="0.5"
          :max="2.0"
          :step="0.1"
          style="width: 100%"
          placeholder="0.5-2.0，Mặc định1.0"
        />
      </el-form-item>
      <el-form-item label="Bật truyền phát (Streaming)" prop="zhipu.stream">
        <el-switch v-model="model.zhipu.stream" />
      </el-form-item>
      <el-form-item v-if="model.zhipu.stream" label="Định dạng mã hoá" prop="zhipu.encode_format">
        <el-select v-model="model.zhipu.encode_format" placeholder="Vui lòng chọn định dạng mã hoá" style="width: 100%">
          <el-option label="Base64" value="base64" />
          <el-option label="Hex" value="hex" />
        </el-select>
      </el-form-item>
      <el-form-item label="Thời lượng khung (ms)" prop="zhipu.frame_duration">
        <el-input-number
          v-model="model.zhipu.frame_duration"
          :min="1"
          :max="1000"
          style="width: 100%"
          placeholder="ms"
    ...
    <template v-if="model.provider === 'minimax'">
      ...
      <el-form-item label="Mô hình" prop="minimax.model">
        <el-input v-model="model.minimax.model" placeholder="speech-2.8-hd" />
      </el-form-item>
      <el-form-item label="Giọng đọc" prop="minimax.voice">
        <el-select
      ...
      <el-form-item label="Âm lượng" prop="minimax.vol">
        <el-input-number
          v-model="model.minimax.vol"
          :min="0"
          :max="2"
          :step="0.1"
          style="width: 100%"
          placeholder="0-2，Mặc định1.0"
        />
      </el-form-item>
      <el-form-item label="Cao độ" prop="minimax.pitch">
        <el-input-number
          v-model="model.minimax.pitch"
          :min="-12"
          :max="12"
          :step="1"
          style="width: 100%"
          placeholder="-12 đến 12, mặc định 0"
        />
      </el-form-item>
      <el-form-item label="Tần số lấy mẫu" prop="minimax.sample_rate">
        <el-input-number
          v-model="model.minimax.sample_rate"
          :min="8000"
          :max="48000"
          :step="1000"
          style="width: 100%"
          placeholder="Mặc định32000"
        />
      </el-form-item>
      <el-form-item label="Tốc độ bit" prop="minimax.bitrate">
        <el-input-number
          v-model="model.minimax.bitrate"
          :min="32000"
          :max="320000"
          :step="16000"
          style="width: 100%"
          placeholder="Mặc định128000"
        />
      </el-form-item>
      ...
      <el-form-item label="Số kênh âm thanh" prop="minimax.channel">
        <el-input-number
          v-model="model.minimax.channel"
          :min="1"
          :max="2"
          style="width: 100%"
          placeholder="Mặc định1"
        />
      </el-form-item>
    </template>
    ...
    <template v-if="model.provider === 'openai'">
      ...
      <el-form-item label="API URL" prop="openai.api_url">
        <el-input
          v-model="model.openai.api_url"
          placeholder="Nhập API URL (mặc định: https://api.openai.com/v1/audio/speech)"
        />
      </el-form-item>
      <el-form-item label="Mô hình" prop="openai.model">
        <el-input v-model="model.openai.model" placeholder="Nhập tên mô hình (mặc định: tts-1)" />
      </el-form-item>
      <el-form-item label="Giọng đọc" prop="openai.voice">
        <el-select
      ...
      <el-form-item label="Định dạng phản hồi" prop="openai.response_format">
        <el-select
          v-model="model.openai.response_format"
          placeholder="Vui lòng chọn định dạng phản hồi"
          style="width: 100%"
        >
          <el-option label="MP3" value="mp3" />
      ...
      <el-form-item label="Tốc độ nói" prop="openai.speed">
        <el-input-number
          v-model="model.openai.speed"
          :min="0.25"
          :max="4.0"
          :step="0.1"
          style="width: 100%"
          placeholder="0.25-4.0，Mặc định1.0"
        />
      </el-form-item>
      <el-form-item label="Bật truyền phát (Streaming)" prop="openai.stream">
        <el-switch v-model="model.openai.stream" />
      </el-form-item>
      <el-form-item label="Thời lượng khung (ms)" prop="openai.frame_duration">
        <el-input-number
          v-model="model.openai.frame_duration"
          :min="1"
          :max="1000"
          style="width: 100%"
          placeholder="ms"
    ...
    <template v-if="model.provider === 'xunfei'">
      ...
      <el-form-item label="Giọng đọc" prop="xunfei.voice">
        <el-input v-model="model.xunfei.voice" placeholder="Nhập giọng đọc, ví dụ: xiaoyan" />
      </el-form-item>
      <el-form-item label="Mã hoá âm thanh" prop="xunfei.audio_encoding">
        <el-select
          v-model="model.xunfei.audio_encoding"
          placeholder="Vui lòng chọn mã hoá âm thanh"
          style="width: 100%"
        >
      ...
      <el-form-item label="Mã hoá văn bản" prop="xunfei.tte">
        <el-select v-model="model.xunfei.tte" placeholder="Vui lòng chọn mã hoá văn bản" style="width: 100%">
          <el-option label="UTF8" value="UTF8" />
          <el-option label="UNICODE" value="UNICODE" />
          <el-option label="GB2312" value="GB2312" />
        </el-select>
      </el-form-item>
      <el-form-item label="Cách đọc số" prop="xunfei.reg">
        <el-input-number v-model="model.xunfei.reg" :min="0" :max="2" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Kiểu đọc số" prop="xunfei.rdn">
    ...
    <template v-if="model.provider === 'xunfei_super_tts'">
      <XunfeiCommonConfig
        :model-value="model"
        prefix="xunfei_super_tts"
        default-ws-url="wss://cbm01.cn-huabei-1.xf-yun.com/v1/private/mcd9m97e6"
      />
      <el-form-item label="Giọng đọc" prop="xunfei_super_tts.voice">
        <el-select
      ...
      <el-form-item label="Mã hoá âm thanh" prop="xunfei_super_tts.audio_encoding">
        <el-select
          v-model="model.xunfei_super_tts.audio_encoding"
          placeholder="Vui lòng chọn mã hoá âm thanh"
          style="width: 100%"
        >
          <el-option label="RAW" value="raw" />
      ...
      <el-form-item label="Tần số lấy mẫu" prop="xunfei_super_tts.sample_rate">
        <el-select
          v-model="model.xunfei_super_tts.sample_rate"
      ...
      <el-form-item label="Cách đọc số" prop="xunfei_super_tts.reg">
        <el-input-number v-model="model.xunfei_super_tts.reg" :min="0" :max="2" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Kiểu đọc số" prop="xunfei_super_tts.rdn">
        <el-input-number v-model="model.xunfei_super_tts.rdn" :min="0" :max="2" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Tăng cường vần điệu" prop="xunfei_super_tts.rhy">
        <el-input-number v-model="model.xunfei_super_tts.rhy" :min="0" :max="1" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Mức độ khẩu ngữ" prop="xunfei_super_tts.oral_level">
        <el-select
          v-model="model.xunfei_super_tts.oral_level"
          placeholder="Vui lòng chọn mức độ khẩu ngữ"
          style="width: 100%"
        >
      ...
      <el-form-item label="Phân đoạn ngừng nghỉ" prop="xunfei_super_tts.stop_split">
        <el-input-number v-model="model.xunfei_super_tts.stop_split" :min="0" :max="1" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Giữ nguyên khẩu ngữ" prop="xunfei_super_tts.remain">
        <el-input-number v-model="model.xunfei_super_tts.remain" :min="0" :max="1" style="width: 100%" />
      </el-form-item>
      <el-form-item label-width="0">
        <div class="indextts-help">
          <div class="indextts-help-subtitle">
            Dòng x4 hỗ trợ tham số khẩu ngữ; dòng x5/x6 nên tập trung điều chỉnh giọng đọc, tốc độ và tần số lấy mẫu.
          </div>
        </div>
      </el-form-item>
    </template>
    ...
    <template v-if="model.provider === 'indextts_vllm'">
      <el-form-item label-width="0" class="indextts-help-item">
        <div class="indextts-help">
          <div class="indextts-help-head">
            <div class="indextts-help-title">Hướng dẫn tích hợp IndexTTS vLLM</div>
            <div class="indextts-help-subtitle">
              Đảm bảo server hỗ trợ /audio/speech, /audio/voices; nhân bản giọng cần /audio/clone
            </div>
          </div>
          <div class="indextts-help-links">
            <el-link :href="indexTTSDocURL" target="_blank" type="primary" :underline="false"
              >Tài liệu tích hợp (GitHub)</el-link
            >
            <span class="indextts-help-divider">|</span>
            <el-link :href="indexTTSReferenceURL" target="_blank" type="info" :underline="false"
              >Tham khảo api_server.py</el-link
            >
          </div>
      ...
      <el-form-item label="API URL" prop="indextts_vllm.api_url">
        <el-input
          v-model="model.indextts_vllm.api_url"
          placeholder="Nhập địa chỉ dịch vụ IndexTTS (ví dụ: http://127.0.0.1:7860)"
        />
      </el-form-item>
      <el-form-item label="API Key" prop="indextts_vllm.api_key">
        <el-input
          v-model="model.indextts_vllm.api_key"
          placeholder="Tùy chọn, điền khi cần"
          type="password"
          show-password
        />
      </el-form-item>
      <el-form-item label="Mô hình" prop="indextts_vllm.model">
        <el-input v-model="model.indextts_vllm.model" placeholder="indextts-vllm" />
      </el-form-item>
      <el-form-item label="Giọng đọc" prop="indextts_vllm.voice">
        <el-select
      ...
      <el-form-item label="Thời lượng khung (ms)" prop="indextts_vllm.frame_duration">
    ...
    <template v-if="model.provider === 'cosyvoice'">
      <el-form-item label="API URL" prop="cosyvoice.api_url">
        <el-input v-model="model.cosyvoice.api_url" placeholder="Nhập API URL" />
      </el-form-item>
      <el-form-item label="ID người nói" prop="cosyvoice.spk_id">
        <el-input v-model="model.cosyvoice.spk_id" placeholder="Vui lòng nhập ID người nói" />
      </el-form-item>
      <el-form-item label="Thời lượng khung (ms)" prop="cosyvoice.frame_duration">
        <el-input-number v-model="model.cosyvoice.frame_duration" :min="1" :max="1000" style="width: 100%" />
      </el-form-item>
      <el-form-item label="Tần số lấy mẫu đầu ra" prop="cosyvoice.target_sr">
      ...
      <el-form-item label="Định dạng âm thanh" prop="cosyvoice.audio_format">
        <el-select
          v-model="model.cosyvoice.audio_format"
          placeholder="Vui lòng chọn định dạng âm thanh"
          style="width: 100%"
        >
          <el-option label="MP3" value="mp3" />
          <el-option label="WAV" value="wav" />
      ...
      <el-form-item label="Văn bản hướng dẫn" prop="cosyvoice.instruct_text">
        <el-input v-model="model.cosyvoice.instruct_text" placeholder="Nhập văn bản hướng dẫn (tùy chọn)" />
      </el-form-item>
    </template>
  </el-form>
</template>
...
const DOUBAO_MODEL_OPTIONS = [
  { label: 'Doubao TTS 1.1', value: 'seed-tts-1.1' },
  { label: 'Doubao TTS 2.0 Standard', value: 'seed-tts-2.0-standard' },
  { label: 'Doubao TTS 2.0 Expressive', value: 'seed-tts-2.0-expressive' },
...
const formRef = ref();
// Đảm bảo danh sách giọng đọc luôn là mảng và reactive, dùng cho dropdown
const voiceOptionsList = computed(() => (Array.isArray(props.voiceOptions) ? props.voiceOptions : []));
const indexTTSDocURL =
  'https://github.com/hackers365/milestones-esp32-server-golang/blob/main/doc/indextts_vllm_api.md';
