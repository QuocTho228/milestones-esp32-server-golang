...
import (
	...
	"milestones-esp32-server-golang/internal/domain/asr/doubao/common"
)
...
func ParseResponse(msg []byte) *AsrResponse {
	...
	// Phân tích các cờ messageTypeSpecificFlags.
	...
	// Kiểm tra dữ liệu có được nén hay không.
