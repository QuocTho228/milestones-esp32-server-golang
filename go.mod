module milestones-esp32-server-golang
...
require (
	...
	milestones/manager/backend v0.0.0-00010101000000-000000000000
	voice_server v0.0.0-00010101000000-000000000000
)

// Tham chiếu mô-đun con backend khi tiến trình chính nhúng HTTP Manager.
replace milestones/manager/backend => ./manager/backend

// Tham chiếu mô-đun con asr_server (Git submodule) khi tiến trình chính nhúng asr_server.
