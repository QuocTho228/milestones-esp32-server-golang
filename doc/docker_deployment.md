...
services:
  ...
  main-server:
    image: docker.jsdelivr.fyi/hackers365/milestones_golang:0.1
  backend:
    image: docker.jsdelivr.fyi/hackers365/milestones_backend:0.1
  frontend:
    image: docker.jsdelivr.fyi/hackers365/milestones_frontend:0.1
```
